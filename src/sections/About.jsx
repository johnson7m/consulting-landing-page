    ...
    <section id="about" className="bg-slate-950 py-20 text-white md:py-28">
      <div className="mx-auto grid w-[min(1180px,92%)] gap-10 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <div className="space-y-6 text-lg leading-8 text-slate-300">
          <p>
            We focus on the problems that sit between systems, workflows, and
            execution. That means understanding how staffing teams actually work,
            where visibility breaks down, and where manual friction starts to
            compound.
          </p>
